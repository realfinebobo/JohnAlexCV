    ...
    <div class="page-content">
      ...
      <header id="site_header" class="header mobile-menu-hide">
        ...
        <div class="social-links">
          <ul>
            <li><a href="https://www.linkedin.com/in/realfinebobo" target="_blank"><i
                  class="fab fa-linkedin-in"></i></a></li>
            <li><a href="https://facebook.com/realfinebobo" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
            <li><a href="https://twitter.com/realfinebobo_" target="_blank"><i class="fab fa-twitter"></i></a></li>
            <li><a href="https://Instagram.com/realfinebobo" target="_blank"><i class="fab fa-instagram"></i></a></li>
            <li><a href="https://tiktok.com/realfinebobo" target="_blank"><i class="fa-brands fa-tiktok"></i></a></li>
            <li><a href="https://muckrack.com/realfinebobo" target="_blank"><i class="fas fa-newspaper"></i></a></li>
          </ul>
        </div>
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <div class="title-block">
                    <h2>Matthew John Alex</h2>
                    <div class="owl-carousel text-rotation">
                      <div class="item">
                        <div class="sp-subtitle">I am a Freelancer</div>
                      </div>
                      <div class="item">
                        <div class="sp-subtitle">Web Developer</div>
                      </div>
                      <div class="item">
                        <div class="sp-subtitle">Digital Journalist</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="section-content">
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-7">
                  <p>I am a web developer with experience in JavaScript, jQuery, HTML/CSS(Bootstrap), and PHP. I am also
                    a digital journalist and copywriter with experience in content creation, SEO, and web design using
                    wordpress, wix and several others.
                  </p>
                  <p>I am passionate about making the world a better place. I have a strong work ethic and work well
                    both independently and collaboratively.
                  </p>
                  <p>In conclusion, I love working with people who care about their work and want to craft products that
                  ...
                  <div class="info-list">
                    <ul>
                      ...
                      <li>
                        ...
                        <span class="value">Ibadan</span>
                      </li>

                      <li>
                        <span class="title">e-mail</span>
                        <span class="value"><a href="mailto: realfinebobo@gmail.com" class="__cf_email__"
                            data-cfemail="72171f131b1e32170a131f021e175c111d1f">Email Me</a></span>
                      </li>

                      <li>
                        <span class="title">Phone</span>
                        <span class="value">+2349082-5337-05</span>
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div class="col-inner">
                    <div class="info-list-w-icon">
                      <div class="info-block-w-icon">
                        ...
                        <div class="ci-text">
                          <h4>Ecommerce</h4>
                          <p>I design professional and responsive E-commerce with payment integration.</p>
                        </div>
                      </div>
                      <div class="info-block-w-icon">
                        <div class="ci-icon">
                        ...
                        <div class="ci-text">
                          <h4>Web Design</h4>
                          <p>I design professional and responsive websites for any category.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-inner">
                    <div class="info-list-w-icon">
                      <div class="info-block-w-icon">
                        ...
                        <div class="ci-text">
                          <h4>Digital content writer</h4>
                          <p>I write digital content for news and entertainment blog, and also SEO content to rank on
                            search engines</p>
                        </div>
                      </div>
                      <div class="info-block-w-icon">
                        ...
                        <div class="ci-text">
                          <h4>Management</h4>
                          <p>I am skilled and certified in social medaia and web Management.</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-4">
                  <div class="fun-fact gray-default">
                    ...
                    <h4>Happy Clients</h4>
                    <span class="fun-fact-block-value">0</span>
          ...
          <section data-id="resume" class="animated-section">
            ...
            <div class="section-content">
              ...
              <div class="row">
                  ...
                  <div class="timeline timeline-second-style clearfix">
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        ...
                        <span class="item-company">Polytechnic Of Ibadan</span>
                      </div>
                  ...
                  <div class="timeline timeline-second-style clearfix">
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        ...
                        <span class="item-company">AHI</span>
                      </div>
                      <div class="divider"></div>
                      <div class="right-part">
                        <h4 class="item-title">YSDP</h4>
                    ...
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        <h5 class="item-period">April 2019 - Dec 2019</h5>
                        <span class="item-company">NiRA</span>
                      </div>
                      <div class="divider"></div>
                      <div class="right-part">
                        <h4 class="item-title">Intern</h4>
                    ...
                    <div class="timeline-item clearfix">
                      ...
                      <div class="divider"></div>
                      <div class="right-part">
                        <h4 class="item-title">Senior Web Developer</h4>
                        <!-- <p>Maecenas tempus faucibus rutrum. Duis eu aliquam urna. Proin vitae nulla tristique, ornare
                          felis id, congue libero. Nam volutpat euismod quam.</p> -->
                      </div>
                    </div>
                    ...
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        <h5 class="item-period">2019-current</h5>
                        <span class="item-company">Naijanews360 <br> Naijatech360</span>
                      </div>
                      <div class="divider"></div>
                      <div class="right-part">
                        <h4 class="item-title">Author</h4>
                        <!-- <p>Maecenas tempus faucibus rutrum. Duis eu aliquam urna. Proin vitae nulla tristique, ornare
                          felis id, congue libero. Nam volutpat euismod quam.</p> -->
                      </div>
                    </div>
                    ...
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        ...
                        <span class="item-company">Igbo Defence</span>
                      </div>
                      <div class="divider"></div>
                      <div class="right-part">
                        <h4 class="item-title">Social Media Manager</h4>
                        <!-- <p>Maecenas tempus faucibus rutrum. Duis eu aliquam urna. Proin vitae nulla tristique, ornare
                          felis id, congue libero. Nam volutpat euismod quam.</p> -->
                      </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-5">
                  <!-- Design Skills -->
                  <div class="block-title design-skill-mob">
                ...
                <div class="col-xs-12 col-sm-12">
                  ...
                  <div class="portfolio-content">
                    ...
                    <ul class="portfolio-filters">
                      ...
                      <li>
                        <a class="filter btn btn-sm btn-link" data-group="category_coperates">Coperates</a>
                      </li>
                      <li>
                    ...
                    <div class="portfolio-grid three-columns">
                      ...
                      <figure class="item lbaudio" data-groups='["category_all"]'>
                        ...
                        <h4 class="name">Naijanews360</h4>
                        <span class="category">Naijanews360</span>
                      </figure>
                      <!-- Portfolio Grid 2 -->
                      ...
                      <figure class="item standard" data-groups='["category_all"]'>
                        ...
                        <h4 class="name">Naijatech360</h4>
                        <span class="category">Naijatech360</span>
                      </figure>
                    </div>
                  </div>
